...
type Server struct {
	...
	// header names. See https://github.com/yonzay/fasthttp/issues/57
	// for details.
	//
...
func (s *Server) Serve(ln net.Listener) error {
	...
	for {
		...
		if !wp.Serve(c) {
			...
			//
			// See also: https://github.com/yonzay/fasthttp/pull/485#discussion_r239994990
...
func (s *Server) serveConn(c net.Conn) (err error) {
	...
	TLSFingerPrint := tlsConn.TLSFingerPrint
	ctx := s.acquireCtx(c)
	ctx.Request.TLSFingerPrint = TLSFingerPrint
...
//
// This function is intended for custom Server implementations.
// See https://github.com/yonzay/httpteleport for details.
